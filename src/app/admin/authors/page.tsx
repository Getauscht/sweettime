...
export default function AuthorsPage() {
    ...
    const handleSave = async () => {
        try {
            ...
            toast('Failed to save author', 'error')
        }
    }
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-white/60 mt-2">Manage webtoon authors</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {loading ? (
                    ...
                    <div className="col-span-full text-white/40 text-center py-12">No authors found</div>
                ) : (
                    authors.map((author) => (
                        <Card key={author.id} className="bg-[#0f0b14] border-white/10 p-6">
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-white/40 text-sm mt-1">{author._count.webtoons} webtoons</p>
                                </div>
                        ...
                        <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50">
                            <Card className="bg-[#0f0b14] border-white/10 p-6 max-w-lg w-full">
                                <div className="flex items-center justify-between mb-6">
                                    <h3 className="text-2xl font-bold text-white">{editing ? 'Edit' : 'New'} Author</h3>
                                ...
                                <div className="flex gap-4 justify-end mt-6">
                                    ...
                                    <Button onClick={handleSave} disabled={uploading} className="bg-purple-600 hover:bg-purple-700 text-white">{editing ? 'Save' : 'Create'}</Button>
                                </div>
                            </Card>
                        </div>
                    </Dialog>
